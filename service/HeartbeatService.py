...
class Heartbeat(heartbeat_pb2_grpc.HearBeatServicer):
    ...
    def isAlive(self, request, context):
        ...
        disk_space = str(psutil.virtual_memory().percent)
        disk_usage = psutil.disk_usage('/')
        # Calculate disk usage percentage
        used_mem = str((disk_usage.used / disk_usage.total) * 100)
    ...
    def getCPUusage(self):
        ...
        disk_usage = psutil.disk_usage('/')
        print('Secondary memory % used', (disk_usage.used / disk_usage.total) * 100)
